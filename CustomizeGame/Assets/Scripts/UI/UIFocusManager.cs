...
public class UIFocusManager : MonoBehaviour
{
    ...
    [SerializeField] private SelectedChangeMethod selectedchangemethod = SelectedChangeMethod.ByTabKey;


    [SerializeField]List<Selectable> SelectableList = new List<Selectable>();
